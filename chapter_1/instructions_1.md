...
**Note:** For point 3 implementation, read current part for chosen scenario from `scenarios` directory and put all your work evidences in `assignment_1` directory.\
    a. Create Account:\
        i. AWS.\
        ii. GitHub.\
    b. Install:\
...
![AWS Free Tier](media_1/image_1.1.PNG)
...
![Select credentials](media_1/image_1.2.PNG)
...
![Add contact information](media_1/image_1.3.PNG)
...
![Add a payment method](media_1/image_1.4.PNG)
...
![Confirm your identity](media_1/image_1.5.PNG)
...
![Select a support plan](media_1/image_1.6.PNG)
...
![GitHub account](media_1/image_1.7.PNG)
...
![Confirm email address](media_1/image_1.10.PNG)
...
![Choose you plan](media_1/image_1.11.PNG)
...
![Python site](media_1/image_1.12.PNG)
...
![Python window](media_1/image_1.13.PNG)

Also, a recommendation is to install all optional features.\
![Optional Features](media_1/image_1.14.PNG)
...
![Python Version](media_1/image_1.15.PNG)
...
![VS Code site](media_1/image_1.16.PNG)
...
![Docker site](media_1/image_1.19.PNG)
...
![Docker installation](media_1/image_1.20.PNG)
...
![Docker Hub](media_1/image_1.21.PNG)

#### pgAdmin 4
Access [pgAdmin 4 site](https://www.pgadmin.org/download/pgadmin-4-windows/) page and downloaded latest version for your OS.\
Once downloaded, run the installer and follow the on-screen instructions to install pgAdmin on your machine.
![pgAdmin site](media_1/image_1.22.PNG)
...
```
![AWS CLI](media_1/image_1.23.PNG)
...
![Terraform site](media_1/image_1.24.PNG)
...
![Environment variables](media_1/image_1.25.PNG)

On the Environment variables edit page, open the Path variable.\
![Edit Environment variables](media_1/image_1.26.PNG)
...
![Edit Path](media_1/image_1.27.PNG)
...
![Terminal Terraform](media_1/image_1.28.PNG)
